...
class SCSEUnet(nn.Module):
    ...
    def __init__(self, n_classes, n_channels):
        ...
        self.conv_encode1 = nn.Sequential(contracting_block(in_channels=self.n_channels, out_channels=32), SCSE(32))
        ...
        self.final_layer = final_block(32, self.n_classes)
...
if __name__ == "__main__":
    model = SCSEUnet(n_classes=8, n_channels=3)
