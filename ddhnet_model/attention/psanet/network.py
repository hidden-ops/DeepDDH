...
from attention.base_model import resnet50
...
if __name__ == "__main__":
    model = PSPNet(19, None)
    image = torch.randn(1, 3, 1024, 1024)
    label = torch.randn(1, 19, 1024, 1024)
    aux_pred, main_pred = model(image)
    print(model)
    print(aux_pred.size(), main_pred.size())